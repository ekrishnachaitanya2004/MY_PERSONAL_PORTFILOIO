...
function i() {
  return i = Object.assign ? Object.assign.bind() : function(t2) {
    for (var i2 = 1; i2 < arguments.length; i2++) {
      var n2 = arguments[i2];
      for (var s in n2) ({}).hasOwnProperty.call(n2, s) && (t2[s] = n2[s]);
    }
    return t2;
...
var n = class extends t {
  constructor(t2 = {}) {
    super(), this.name = "SwupFadeTheme", this.defaults = { mainElement: "#swup" }, this.options = void 0, this.options = i({}, this.defaults, t2);
  }
  mount() {
    this.applyStyles("html{--swup-fade-theme-duration:0.4s}html.is-changing .swup-transition-main{opacity:1;transition:opacity var(--swup-fade-theme-duration)}html.is-animating .swup-transition-main{opacity:0}"), this.addClassName(this.options.mainElement, "main");
  }
};
export {
  n as default
